...
typedef struct tagRGBQUAD {
	...
	BYTE	rgbRed;
	BYTE	rgbReserved;
} PACKED_STRUCT RGBQUAD,*LPRGBQUAD;
...
typedef struct tagBITMAPFILEHEADER {
	...
	WORD	bfReserved2;
	DWORD	bfOffBits;
} PACKED_STRUCT BITMAPFILEHEADER,*LPBITMAPFILEHEADER,*PBITMAPFILEHEADER;
...
} PACKED_STRUCT BITMAPINFOHEADER,*LPBITMAPINFOHEADER,*PBITMAPINFOHEADER;
#endif
